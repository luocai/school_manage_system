    		...
    		<div class = "col-md-10">
    			<div class = "panel panel-default">
    				<div class = "panel-heading">
    					<div class = "row"> 
    						<h1 style="text-align:center">增加学生信息</h1>
    					</div>
    				<div class = "panel-body">
	    				<form action = "admin/addStudent" class = "form-horizontal" role = "form" method = "post">
	    					...
	    					<div class="form-group">
	    						...
	    						<div class="col-sm-4">
	    							<input type="date" class="form-control" name="birthyear" name="birthyear" placeholder="1996-09-02"/>
	    						</div>
	    					</div>
	    					<div class="form-group">
	    						<label for="inputPassword3" class="col-sm-2 control-label">入学时间</label>
	    						<div class="col-sm-4">
	    							<input type="date" class="form-control" name="grade" placeholder=" 2015-09-01"/>
	    						</div>
	    					</div>
	    					<div class="form-group">

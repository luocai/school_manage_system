...
import com.cai.mapper.TeacherMapperCustom;
...
public class TeacherServiceImpl implements TeacherService {
	...
	public List<TeacherCustom> findByPage(PageBean pageBean) throws Exception {
		...
		return teacherMapperCustom.findByPage(pageBean);
	}
		 ...
		 List<Teacher> list = teacherMapper.selectByExample(teacherExample);
	        ...
	        if (list != null) {
	            ...
	            for (Teacher t : list) {
	                TeacherCustom teacherCustom = new TeacherCustom();
	                //类拷贝
	                org.springframework.beans.BeanUtils.copyProperties(t, teacherCustom);
	                //获取课程名
